...
*
*/
define('APP_BASE_URL', 'https://its-center.ru/crm/');
...
*/
define('APP_ENC_KEY', 'b1a8000ae41d4893d864064319698407');
 ...
 */
define('APP_DB_USERNAME', 'shinaspec_its');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'r*cS8hTq');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'shinaspec_its');
