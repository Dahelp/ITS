...
$titleSafe   = htmlspecialchars($title ?? 'Запрос каталога', ENT_QUOTES, 'UTF-8');
$namecompSafe = htmlspecialchars($namecomp ?? '', ENT_QUOTES, 'UTF-8');
$tellSiteSafe = htmlspecialchars($tell_site ?? '', ENT_QUOTES, 'UTF-8');
?>
...
<table style="width:740px;margin:0 auto;background-color:#f4f6f9;font-family:Tahoma, Helvetica, sans-serif;color:#212529;font-size:13px;border:1px solid #eee;" cellspacing="0" cellpadding="0">
    <tr>
        <td style="padding:20px;width:300px;">
            <img src="<?= PATH ?>/images/logo.png" alt="<?= $namecompSafe ?>" style="width:260px;height:50px;">
        </td>
                            ...
                            <tr>
                                <td style="padding:20px 0;">
                                    <div style="font-size:18px;font-weight:bold;margin-bottom:20px;color:#2C3E50;">
                                        На сайт <?= $namecompSafe ?> поступила новая заявка на получение каталога
                                    </div>
                                    ...
                                    <br><br>
                                    С уважением, <?= $namecompSafe ?><br>
                                    <b>Телефон:</b> <?= $tellSiteSafe ?>
                                </td>
                            </tr>
                        </table>
                    </td>
