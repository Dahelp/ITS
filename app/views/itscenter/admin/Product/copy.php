                        ...
                        <div class="tab-pane active" id="tab_1">
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="short_description" id="editor2" cols="80" rows="6"><?=$product->short_description ?? '';?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                  ...
                  <div class="tab-pane" id="tab_3">
                    <div class="box-body">
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-9">
								<?php $name_tg = ''; ?>
                                <input type="text" name="name_tag" class="form-control" id="name_tag"
                                    placeholder="Заполняются через запятую (1-5 фраз)"
                                    value="<?php foreach($tags_product as $tag_item){
