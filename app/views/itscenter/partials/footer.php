<!--footer-starts-->
	<footer class="site-footer site-footer--deluxe">
		...
		<div class="container">
			<div class="row site-footer__top">
				...
				<div class="col-lg-3 col-md-6 site-footer__col site-footer__brand">
					...
					<div class="site-footer__brand-text">
						Поставки шин, дисков, камер, ободных лент и фильтров для складской, строительной и спецтехники.
					</div>
				</div>
				...
				<div class="col-lg-2 col-md-6 site-footer__col">
					...
					<ul class="site-footer__menu list-unstyled">
						...
						<li><a href="promo" class="is-accent">Акции</a></li>
					</ul>
				</div>
				...
				<div class="col-lg-2 col-md-6 site-footer__col">
					...
					<ul class="site-footer__menu list-unstyled">
						<li><a href="pages/kak-kupit">Как купить</a></li>
				...
				<div class="col-lg-2 col-md-6 site-footer__col">
					...
					<ul class="site-footer__menu list-unstyled">
						<li><a href="pages/about-us">О компании</a></li>
						<li><a href="news">Новости</a></li>
						<li><a href="articles">Статьи</a></li>
						<li><a href="pages/contacts">Контакты</a></li>
						<li><a href="sitemap">Карта сайта</a></li>
						<li><a href="articles/shinnyy-kalkulyator-na-sayte-its-centr">Шинный калькулятор</a></li>
					</ul>
				</div>
			...
			<div class="site-footer__contacts-row">
				<div class="site-footer__contact-item site-footer__contact-item--phone">
					<div class="site-footer__contact-label">Телефон</div>
					<a href="tel:+74954249890" class="site-footer__contact-main">+7 (495) 424-98-90</a>
				</div>
				...
				<div class="site-footer__contact-item">
					<div class="site-footer__contact-label">Режим работы</div>
					<div class="site-footer__contact-text">Пн-Пт 9:00 – 17:00</div>
				</div>

				<div class="site-footer__contact-item site-footer__contact-item--address">
					<div class="site-footer__contact-label">Адрес</div>
					<div class="site-footer__contact-text">142115, МО, Подольск, мкр. Климовск, ул. Коммунальная 26, стр. 2</div>
				</div>
			</div>
				...
				<div class="site-footer__bottom-inner">
					...
					<div class="site-footer__bottom-right">
						<div class="site-footer__payments">
							<div class="site-footer__payments-label">Принимаем к оплате</div>
							<div class="card-accepted-payment">
								<div class="logos">
						...
						<div class="site-footer__socials">
							...
							<a href="https://ok.ru/group/54227545423872" target="_blank" rel="noopener noreferrer" class="social-link social-link--ok" title="Одноклассники">
