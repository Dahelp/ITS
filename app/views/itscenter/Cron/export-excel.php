...
$products = \R::getAll("SELECT product.article, product.name, product.quantity, product.price, brand.name as brand_name FROM product, brand WHERE product.brand_id = brand.id AND product.hide = ?", ['show']);
...
foreach($products as $prod) {
	...
	$sheet->setCellValue('E'.$pos.'', ''.$prod["price"].'');
}
