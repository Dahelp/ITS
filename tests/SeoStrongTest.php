...
$cases = [
    ...
    [
        '/category/shiny-dlya-minipogruzchikov',
        '<h1>Шины для минипогрузчиков</h1><p>Шины для минипогрузчиков применяются на стройплощадках.</p>',
        '<p><strong>Шины для минипогрузчиков</strong> применяются на стройплощадках.</p>',
    ],
    [
